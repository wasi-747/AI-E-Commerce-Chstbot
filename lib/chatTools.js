...
export const browseProducts = tool({
  ...
  inputSchema: z.object({
    query: z.string().describe("The specific search term — must be a product type, brand, or attribute. Examples: 'nike running tee', 'black jeans', 'gym shorts'. Never pass vague phrases like 'clothes' or 'something nice'.")
  }),
  execute: async ({ query }) => {
    await dbConnect();
